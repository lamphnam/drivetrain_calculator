...
@Entity
@Table(
        name = "module4_shaft_force",
        uniqueConstraints = @UniqueConstraint(
                name = "uq_module4_force_result_shaft",
                columnNames = {"module4_result_id", "shaft_code"}
        )
)
@Getter
@Setter
...
@AllArgsConstructor
@Builder
@ToString(exclude = "module4Result")
public class Module4ShaftForce {
    ...
    @JoinColumn(name = "module4_result_id", nullable = false)
    private Module4Result module4Result;
}
